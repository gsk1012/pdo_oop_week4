...
if ($_GET['telefoonID']) {
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        try {
            $db->editTelefoon($_POST['merk'], $_POST['model'], $_POST['opslag_in_gb'], $_POST['prijs'], $_GET['telefoonID']);
            echo "<h1 style='text-align:center;'>Telefoon gegevens zijn bewerkt</h1>";
...
<body>
    <h1>Telefoon gegevens bewerken</h1>
